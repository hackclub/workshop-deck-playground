...
- You'll need to change `000000` to `05870025`.
...
# Time for another test run! Pin: 05149029
...
<Text sx={{ color: 'purple', textShadow: '0 0 12px currentColor', fontSize: 10, fontWeight: 'bold' }}>Final Round! Pin: 04358110</Text>
