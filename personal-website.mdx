...
import { Grid, Flex, Box, Image, Text } from "theme-ui"
...
<Flex sx={{ flexDirection: 'column', px: '10px' }}>
...
<Text>https://github.com/hackclub/dinosaurs/raw/master/smart_dinosaur_docs.png</Text>
